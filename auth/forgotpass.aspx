...
<body style="background: url(../images/forgot.png) no-repeat scroll 0pt 0pt transparent;">
   ...
   <table class="style13">
                             ...
                             <span id="lbError" style="color:Red;" ></span><br />
                                    ...
                                    <tr>
                                        <td class="style19">
                                           <span  style="font-size: 18px; color: #F60; font-weight: bold;">Conta：</span>
                                        </td>
                                        <td class="style20">
                                    ...
                                    <tr>
                                        <td class="style19">
                                            <span  style="font-size: 18px; color: #F60; font-weight: bold;">Código:&nbsp;&nbsp;&nbsp; </span>
                                            </td>
                                        <td class="style20">
                                             <table style="width: 27%;">
                                                 <tr>
                                                     ...
                                                     <td>
                                                        <a id="ReLoad" title="" href="javascript:href()" style="font-size: 12px; color: blue">recarregar</a> </td>
                                                 </tr>
                                             </table>
                                             </td>
                                    </tr>
                                    <tr>
                                        <td class="style19">
                                           <span  style="font-size: 18px; color: #F60; font-weight: bold;">Digite o código de segurança：</span>
                                           </td>
                                        <td class="style20">
		...
		<marquee>	<img src="../images/captain.png" height="225" width="255"/><h2>Vamos recuperar sua senha, não se preocupe !</h2></marquee>
</body>
</html>
